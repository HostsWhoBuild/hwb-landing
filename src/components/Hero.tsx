        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cream/10 border border-cream/20 mb-8 animate-fade-in">
            ...
            <span className="text-cream/90 text-sm font-medium">
              Join 500+ Hosts Building Together
            </span>
          </div>
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl md:text-2xl text-cream/80 max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            <a
              ...
              className="btn-primary flex items-center gap-2 text-lg group w-full sm:w-auto justify-center"
            >
          ...
          {/* Trust Indicators */}
          <div className="mt-16 pt-8 border-t border-cream/10 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <p className="text-cream/50 text-sm mb-4">Trusted by hosts worldwide</p>
            <div className="flex flex-wrap items-center justify-center gap-8 text-cream/40">
              <div className="flex items-center gap-2">
                <span className="text-2xl font-bold text-cream">500+</span>
                <span className="text-sm">Active Hosts</span>
              </div>
              <div className="w-px h-8 bg-cream/20 hidden sm:block" />
              <div className="flex items-center gap-2">
                <span className="text-2xl font-bold text-cream">50+</span>
                <span className="text-sm">Countries</span>
              </div>
              <div className="w-px h-8 bg-cream/20 hidden sm:block" />
              <div className="flex items-center gap-2">
                <span className="text-2xl font-bold text-cream">1000+</span>
